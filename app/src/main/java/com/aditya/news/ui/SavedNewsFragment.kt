...
import com.aditya.news.databinding.FragmentSavedNewsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getSavedNews().observe(viewLifecycleOwner, { articles ->
            if(articles.isEmpty()) {
                ...
                binding.ivNoArticleSaved.visibility = View.VISIBLE
            } else {
                binding.tvMessage.visibility = View.INVISIBLE
                binding.ivNoArticleSaved.visibility = View.INVISIBLE
            }
